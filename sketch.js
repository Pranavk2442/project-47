...
var destinationEarth, destinationEarthimg;
...
destinationEarthimg=loadImage("destinationEarth.png");
...
function setup(){
  ...
  // spaceship.addImage(spaceshipimg);
   ...
   startButton=createSprite(600,300);
   ...
   destinationEarth=createSprite(600,80,20,20);
   destinationEarth.addImage(destinationEarthimg);
   destinationEarth.visible=false;
...
function draw(){
  ...
  // bgSound.loop();
    ...
    if(gameState===0){
        ...
        destinationEarth.visible=true;

        textSize(20);
        text("Use left and right arrows to move, and press space to shoot. Shoot as many asteroids as you can to win!!",120,200);
    ...
    if(gameState===1){
      ...
      //  startButton.setCollider("rectangle",0,0,0,0);
       //earth.visible=false;
        ...
        if(score>=5){
            asteroidGroup.setVelocityYEach(6);
           // console.log(4);
        //   alert("4");
        ...
        if(score>=15 ){
            asteroidGroup.setVelocityYEach(8);
            //console.log(6);
           // alert("6");
        }

        if(score>=25 ){
            asteroidGroup.setVelocityYEach(10);
        ...
        if(score>=40){
            asteroidGroup.setVelocityYEach(15);
        }
